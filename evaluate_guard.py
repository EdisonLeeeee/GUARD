...
from graphwar.defense.model_level import MedianGCN, RobustGCN, ReliableGNN, ElasticGNN
from graphwar.utils import split_nodes
from graphwar import set_seed
from graphwar.utils import flip_graph
from graphwar.functional import feat_normalize
from ogb.nodeproppred import DglNodePropPredDataset

from guard import GUARD, RandomGUARD, DegreeGUARD
from logger import setup_logger

log = setup_logger(name='GUARD EXP', output='GUARD-xxx.txt')
...
def evaluate_guard(dataset='cora', defense="GUARD", attack='SGAttack', model="SGC", seed=2022, k=500, alpha=2, clean=False):
    ...
    # ============ Load datasets ================================
    data = GraphWarDataset(dataset, verbose=True, standardize=True if dataset !='reddit' else False)
    g = data[0]
    y = g.ndata['label']
...
#       FGAttack and IGAttack are not available on large datasets    #
# ================================================================== #
k = 20000
alpha = 2.0
for clean in [False]:
