...
def setup_logger(
    ...
    color: bool = True, name: str = "graphattack", abbrev_name: Optional[str] = None
):
    """Initialize the graphattack logger and set its verbosity level to "DEBUG".
    ...
    name : str, optional
        the root module name of this logger, by default "graphattack"
...
def get_logger(name="graphattack"):
